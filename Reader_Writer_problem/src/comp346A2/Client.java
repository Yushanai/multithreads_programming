...
public class Client extends Thread { 
    ...
    private  String clientSendingStatus;	 /* Running status of thread 1 - idle, running, terminated */
	private  String clientReceivingStatus;	 /* Running status of thread 2 - idle, running, terminated */    
	 ...
	 */
	 ...
	 public void setclientSendingStatus(String status)
	 { 
		 clientSendingStatus = status;
	 }
	 public void setclientReceivingStatus(String status)
	 { 
		 clientReceivingStatus = status;
	 }
	 
	 public String getclientSendingStatus()
	 { 
		 return clientSendingStatus;
	 }
	 public String getclientReceivingStatus()
	 { 
		 return clientSendingStatus;
	 }
    /** 
    ...
    {   
    	...
    	long sendClientStartTime, sendClientEndTime, receiveClientStartTime, receiveClientEndTime;
    	 ...
    	 if(getClientOperation().equals("sending")){
    		 setclientSendingStatus("running");
             ...
             setclientSendingStatus("terminated");
    		 ...
    		 setclientReceivingStatus("running");
             ...
             setclientReceivingStatus("terminated");
