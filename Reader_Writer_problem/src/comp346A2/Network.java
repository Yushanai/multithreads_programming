...
public class Network extends Thread {
    ...
    private static Semaphore outGoingEmpty;
    private static Semaphore outGoingfull ;
    private static Semaphore inComingempty;
    private static Semaphore inComingFull;
    private static Semaphore inComingMutex;
    private static Semaphore outGoingMutex;
     ...
     */
     Network( )
      { 
         ...
         outGoingEmpty = new Semaphore(maxNbPackets);
         outGoingfull =new Semaphore(0) ;
         inComingempty = new Semaphore(maxNbPackets);
         inComingFull = new Semaphore(0);
         outGoingMutex =  new Semaphore(1);
         inComingMutex =  new Semaphore(1);
      }     
