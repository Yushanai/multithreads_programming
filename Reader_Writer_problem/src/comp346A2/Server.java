...
public class Server extends Thread {
	...
	//private static Semaphore updateAcc;
	private static Semaphore updateAcc = new Semaphore(1);
    /** 
       ...
       */
        ...
        */
         ...
         */
         ...
         private void setServerThreadRunningStatus3(String runningStatus) {
     ...
     public boolean processTransactions(Transactions trans) throws InterruptedException   {
    	...
    	updateAcc.acquire();
         ...
         {      
        	...
        	// while ( (Network.getInBufferStatus().equals("empty") && !Network.getClientConnectionStatus().equals("disconnected")) )   // Alternatively, busy-wait until the network input buffer is available 
        	// {         
     ...
     */
     ...
     public double deposit(int i, double amount) throws InterruptedException
     { 
     ...
     */
     ...
     public double withdraw(int i, double amount) throws InterruptedException
     { 
    	 double curBalance;      /* Current account balance */
     ...
     */
     ...
     public void run(){   
    	...
    	if(serverThreadId.equals("3")) {
     	...
     	// .....................................................................................................................................................................................................
    	//Disconnect to network when both threads are terminated 
